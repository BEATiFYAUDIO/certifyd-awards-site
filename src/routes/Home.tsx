    ...
    <>
      <section className="awards-hero creator-hero">
        ...
        <aside className="hero-award-visual" aria-hidden="true">
          <img src="/media/certifyd-awards-modern-trophy.png?v=20260717-fixed-logo-v1" alt="" />
        </aside>
      ...
      <section className="founders-home-section">
        ...
        <figure className="founders-home-visual" aria-label={foundersAward.name}>
          <img src="/media/certifyd-awards-modern-trophy.png?v=20260717-fixed-logo-v1" alt="Certifyd Awards gold music note trophy" />
        </figure>
      </section>
