...
export function NomineeDetail() {
  ...
  if (!entry) {
    if (loading) return <section className="standard-title-hero"><div className="standard-title-hero-content"><p className="lead">Loading award entry…</p></div></section>;
    if (staleSeededEntry) {
      return (
  ...
  return (
    <>
      <section className="standard-title-hero">
        <div className="standard-title-hero-content category-title-layout nominee-title-layout">
          <div>
      ...
      <section className="page-section detail-page standard-page-content">
