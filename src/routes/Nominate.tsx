    ...
    <>
      ...
      <section className="page-section form-page standard-page-content">
        ...
        <form className="glass-card nomination-form" onSubmit={onSubmit}>
          ...
          <label>Why should this be recognized?<textarea required name="supportingContext" rows={5} placeholder="Tell the story, list contributors, and include receipts, manifests, credits, hashes, or public records when available." /></label>
