...
export const technologyCategories: TechnicalCategory[] = [
  { id: 'tech-infra-provider', slug: 'infrastructure-provider-of-the-year', title: 'Infrastructure Provider of the Year', family: 'Infrastructure', summary: 'Recognizes the provider with the strongest reliability, public readiness, and creator-network utility.', eligibility: ['Public or partner-facing infrastructure', 'Operational telemetry available', 'Documented role in creator publishing or access'], metrics: ['Availability', 'Requests served', 'Proof resolution time', 'Operational transparency'] },
  { id: 'tech-public-node', slug: 'public-node-of-the-year', title: 'Public Node of the Year', family: 'Infrastructure', summary: 'Recognizes a public node that makes creator works, profiles, and proof records consistently discoverable.', eligibility: ['Public node origin', 'Discoverable records', 'Node identity continuity'], metrics: ['Uptime', 'Discovery response rate', 'Catalog size', 'Metadata completeness'] },
  { id: 'tech-identity-provider', slug: 'identity-provider-of-the-year', title: 'Identity Provider of the Year', family: 'Platforms and Providers', summary: 'Recognizes systems that make creator identity portable, verifiable, and useful across surfaces.', eligibility: ['Creator identity records', 'Verification process', 'Profile portability'], metrics: ['Verified identities', 'Profile completeness', 'Resolution latency'] },
  { id: 'tech-api-excellence', slug: 'api-excellence-award', title: 'API Excellence Award', family: 'Developer Technology', summary: 'Recognizes API design that helps developers integrate creator proof, commerce, and playback authorization.', eligibility: ['Documented public or partner API', 'Stable error model', 'Versioning discipline'], metrics: ['Availability', 'Latency', 'Docs coverage', 'Developer adoption'] },
  ...
  { id: 'tech-metadata', slug: 'metadata-excellence-award', title: 'Metadata Excellence Award', family: 'Data and Transparency', summary: 'Recognizes high-quality metadata, attribution, rights, and manifest coverage.', eligibility: ['Structured metadata', 'Contributor records', 'Rights fields'], metrics: ['Completeness', 'Consistency', 'Proof coverage'] },
